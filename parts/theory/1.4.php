 ...
 *
 * Zacniemy od operatora, który już wcześniej używaliśmy ale go nigdy nie nazwaliśmy. Mianowicie od operatora
 ...
 * dodawanie
 *
 * Dodawać do siebi możemy dwie wartości i finalnie rezultat działania przypisujemy z pomocą operatora przypisania do
 * zmiennej $result
 *
...
/**
 * Możemmy się już domyślić jak działa preinkrementacja, ale czy do końca?
 *
 * Kolejne kroki:
...
/**
 * Opreratory sprawdzające czy wartoście po jego obu stronach (operandy) są takie same:
 * ==
 * ===
 * Pomiędzy nimi jest jedna znacząca różnica.
 * Używając podwójnego znaku równa się sprawdzamy czy wartość znajdująca sie po lewej strnie jest równa wartości
