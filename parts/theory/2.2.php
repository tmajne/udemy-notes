...
/*
    switch (sprawdzanaWartosc) {
        case 'foo':
            // blok kodu do wykonania gdy sprawdzanaWartosc wynoci 'foo'
            break;
        case 'bar':
            // blok kodu do wykonania gdy sprawdzanaWartosc wynoci 'bar'
            break;
        case 'zaz':
            // blok kodu do wykonania gdy sprawdzanaWartosc wynoci 'zaz'
            break;
        default:
 ...
 * Przeanalizjmy krok po kroku jak to zadziałało.
 *
 * W zmiennej $value przechowujemy wartość 'bar'
 * W instrukcji swithc chcemy na podstawie tego co przechowuje zmienna $value wykonać odpowiedni kod.
 ...
 *
 * Nie wspomnieliśmy jeszcze o tym do czego służy słowo kluczowe 'break' i czy jest wogóle istotne.
...
/**
 * Wygląda jeszcze bardzię zwięzle, jedna jego działanie różnie się diametralnie.
 * Rezultatem który odtrzymany będzie wyświetlenie:
 */
/*
    value ma wartość: bar
